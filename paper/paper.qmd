...
Define $y_i$ as the number of suspected non fatal overdoses in a given quarter in a given shelter.  Then $\beta_i$ is the wing width and $\gamma_i$ is the wing length, both measured in millimeters.
